...
for service in all-apps-runner daily-engine agentic-social trillions codexes-factory resume collectiverse altdoge max-bialystok rkhs-viewer; do
...
ssh -i "$SSH_KEY" "$REMOTE_USER@$REMOTE_HOST" << 'ENDSSH'
for dir in xcu_my_apps/all_applications_runner xcu_my_apps/personal xcu_my_apps/xtuff/agentic_social_server xcu_my_apps/xtuff/trillionsofpeople xcu_my_apps/nimble/codexes-factory xcu_my_apps/xtuff/resume-site xcu_my_apps/xtuff/collectiverse xcu_my_apps/xtuff/altDOGE xcu_my_apps/hilberts/viewer; do
    mkdir -p ~/${dir}/logs
